...
//
// Duplicated (not shared) in packages/backend/src/data/uzbekistanRegions.ts
// and packages/storefront/src/data/uzbekistanRegions.ts - this project keeps
// per-package copies of small reference data rather than a shared internal
// package (same pattern as OrderStatus/TenantStatus). Used here only to
// render code -> display-name lookups for an order's saved address, not for
// any input/validation (admin has no order-creation UI).
